...
class MastersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post masters_url, params: { master: { nombre: @master.nombre, universidad_id: @master.universidad_id, url: @master.url } }
    end
  ...
  test "should update master" do
    patch master_url(@master), params: { master: { nombre: @master.nombre, universidad_id: @master.universidad_id, url: @master.url } }
